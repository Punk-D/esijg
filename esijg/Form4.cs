...
namespace esijg
{
    public partial class Form4 : Form
    {
        ...
        {
            {
                adapter = new SqlDataAdapter("SELECT M.ID_Nota, S.Nume + ' ' + S.Prenume AS Student, \r\n       O.Denumire AS Obiect, P.Nume + ' ' + P.Prenume AS Profesor, \r\n       M.Nota, M.Data_Notarii\r\nFROM Note AS M\r\nINNER JOIN Elevi AS S ON M.ID_Elev = S.ID_Elev\r\nINNER JOIN Obiecte AS O ON M.ID_Obiect = O.ID_Obiect\r\nINNER JOIN Profesori AS P ON M.ID_Profesor = P.ID_Profesor;\r\n", connection);
