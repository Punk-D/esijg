...
namespace esijg
{
    public partial class Form6 : Form
    {
        ...
        {
            {
                adapter = new SqlDataAdapter("SELECT G.ID_Grupa, G.An_de_studii, G.Specialitate, \r\n       P.Nume + ' ' + P.Prenume AS Profesor_Coordonator\r\nFROM Grupe AS G\r\nINNER JOIN Profesori AS P ON G.ID_Profesor = P.ID_Profesor;\r\n", connection);
